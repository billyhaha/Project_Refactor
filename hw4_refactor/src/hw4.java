...
public class hw4
{
	...
	{	
		...
		while(game)
		{
			...
			Assassin assassin = new Assassin(80,50,1,1);
			Barbarian barbarian = new Barbarian(120,0,1,-1);
			Master master = new Master(50,100,1,1);
			Archer archer = new Archer(60,80,1,1);
			Wizard wizard = new Wizard(80,0,1,-1);
			Priest priest = new Priest(60,100,1,1);
			Witch witch =new Witch(80,0,1,-1);
			...
			while(mission)
			{
				...
				switch(map[location.x][location.y])
				{
					case"A":
						...
						battlefield.operate.cdInitialize(battlefield, knight, assassin, master, archer, priest);
						break;
					case"B":
						System.out.println("修怕囉");
